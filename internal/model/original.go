...
// ChangedFunctionLocation pairs a modified function name with its source file path.
type ChangedFunctionLocation struct {
...
type OriginalPR struct {
	...
	ChangedFunctions         []string                  `json:"changed_functions"`                    // Enclosing C functions modified in diff (flat list for backward compatibility)
	ChangedFunctionLocations []ChangedFunctionLocation `json:"changed_function_locations,omitempty"` // Path-associated C function symbols
